...
const MOCK_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    price: 8959,
    category: 'Electrical',
    image: 'https://images.unsplash.com/photo-1548430632-deea41ecaf0d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb3RvcmN5Y2xlJTIwTEVEJTIwaGVhZGxpZ2h0fGVufDF8fHx8MTc2MjMyMzA1MXww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
  ...
  {
    id: '4',
    name: 'Pro Taper Handlebars',
    price: 4479,
    category: 'Controls',
    image: 'https://images.unsplash.com/photo-1548397431-1331aae307de?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb3RvcmN5Y2xlJTIwaGFuZGxlYmFyc3xlbnwxfHx8fDE3NjIzMjMwNTF8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
  ...
  {
    id: '5',
    name: 'All-Terrain Competition Tire',
    price: 7279,
    category: 'Wheels & Tires',
    image: 'https://images.unsplash.com/photo-1754879261736-56330253c62a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxkaXJ0JTIwYmlrZSUyMHRpcmV8ZW58MXx8fHwxNzYyMzIzMDUxfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
    description: 'Advanced tread pattern for exceptional traction on all surfaces. Durable compound for extended life.',
    make: ['Honda', 'Yamaha', 'Kawasaki', 'Suzuki', 'KTM', 'Husqvarna', 'Beta', 'GasGas'],
  ...
  {
    id: '6',
    name: 'Engine Crash Bar Kit',
    price: 11199,
    category: 'Bike Protection',
    image: 'https://images.unsplash.com/photo-1745042331387-4f489944eda2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb3RvcmN5Y2xlJTIwY3Jhc2glMjBiYXJzfGVufDF8fHx8MTc2MjMyMzA1Mnww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
    description: 'Heavy-duty crash bars to protect engine cases and frame. Bolt-on installation.',
    make: ['KTM', 'Husqvarna', 'Beta', 'GasGas'],
    model: ['450 SX-F', '350 EXC-F', '300 XC', 'FC 450', 'TE 300i', 'RR 300', 'RR 430', 'EC 300'],
  ...
  },
  {
    ...
    price: 19599,
    category: 'Suspension',
    image: 'https://images.unsplash.com/photo-1701836924325-3bdbfc2e8689?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb3RvcmN5Y2xlJTIwc2hvY2slMjBhYnNvcmJlcnxlbnwxfHx8fDE3NjIzMjMwNTJ8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
  ...
  },
  {
    ...
    price: 33599,
    category: 'Exhaust',
    image: 'https://images.unsplash.com/photo-1675247911627-0fb610250598?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb3RvcmN5Y2xlJTIwZXhoYXVzdCUyMHN5c3RlbXxlbnwxfHx8fDE3NjIzMjMwNTN8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
  ...
  },
  {
    ...
    price: 5039,
    category: 'Body & Frame',
    image: 'https://images.unsplash.com/photo-1513634068358-fc88c9a97c6e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxkaXJ0JTIwYmlrZSUyMGdyYXBoaWNzJTIwZGVjYWxzfGVufDF8fHx8MTc2MjMyMzA1M3ww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
    description: 'Premium vinyl graphics kit with UV-resistant finish. Easy installation with pre-cut panels.',
    make: ['Honda', 'Yamaha', 'Kawasaki', 'Suzuki', 'KTM', 'Husqvarna'],
    model: ['CRF450R', 'CRF250R', 'YZ450F', 'YZ250F', 'KX450F', 'RM-Z450', '450 SX-F', '250 SX-F', 'FC 450'],
    year: ['2018', '2019', '2020', '2021', '2022', '2023', '2024', '2025'],
    inStock: true,
    rating: 4.5,
    reviews: 134
  },
  {
    ...
    price: 2799,
    category: 'Air & Fuel',
    image: 'https://images.unsplash.com/photo-1604492642440-063264f0b74e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb3RvcmN5Y2xlJTIwYWlyJTIwZmlsdGVyfGVufDF8fHx8MTc2MjMyMzA1NHww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
  ...
  {
    id: '11',
    name: 'Piston Kit - Top-End Rebuild',
    price: 8919,
    category: 'Engine',
    image: 'https://images.unsplash.com/photo-1675247911627-0fb610250598?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb3RvcmN5Y2xlJTIwcGlzdG9uJTIwZW5naW5lfGVufDF8fHx8MTc2MjMyMzA1NHww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
    ...
    model: ['CRF450R', 'CRF250R', 'YZ450F', 'YZ250F', 'KX450F', 'KX250F', 'RM-Z450'],
